...
<main>
  <header>
    ...
    <section>
      ...
      <p>
        대회가 끝나면 더이상 볼 수 없었던 문제들, 모두 안녕!<br />기존에 출제된
        문제들을 재현하여 사이트에서 채점받고, 랭킹을 보며 실력을 증진할 수
        있습니다.
      </p>
    </section>
  </header>
  ...
  <section>
    ...
    <p>
      문제를 풀면 경험치와 레벨이 올라가며 실시간으로 랭킹을 볼 수 있어요.<br
      />어려운 문제일 수록 경험치가 많고, 체감 난이도를 적어 주시면 생태계에
      도움이 돼요!
    </p>
    <ul>
  ...
  <section>
    <h2>원하는 문제가 있으신가요?</h2>
    <p>
      분류와 제목, 난이도, 태그 등 여러 조건을 사용해 내가 원하는 문제를 쉽고
      빠르게 찾을 수 있어요.
    </p>
    <ul>
